...
label_11 = Label(root, text="Student Details",bg="#FCCD04",width=100,height=1,font=("bold", 10))
label_11.place(x=118,y=65)
Button(root, text='Logout',width=15,bg='#FCCD04',height=1,fg='black',command=logout).place(x=930,y=65)
...
label_5 = Label(root, text='Contact',fg="#FFFFFF",bg="#AC3B61", width=15,font=("", 9))
label_5.place(x=400,y=90)
label_6 = Label(root, text='Email',fg="#FFFFFF",bg="#AC3B61", width=16,font=("", 9))
label_6.place(x=514,y=90)
label_7 = Label(root, text="Gender",fg="#FFFFFF",bg="#AC3B61", width=13,font=("", 9))
label_7.place(x=635,y=90)
label_8 = Label(root, text="Address",fg="#FFFFFF",bg="#AC3B61", width=13,font=("", 9))
label_8.place(x=735,y=90)
label_9 = Label(root, text="Year",fg="#FFFFFF",bg="#AC3B61", width=13,font=("", 9))
label_9.place(x=835,y=90)
label_10 = Label(root, text="Birth Date",fg="#FFFFFF",bg="#AC3B61", width=15,font=("", 9))
label_10.place(x=935,y=90)
